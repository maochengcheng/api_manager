package com.guanting.manager.config;


import at.pollux.thymeleaf.shiro.dialect.ShiroDialect;
import com.guanting.manager.filter.KickoutSessionFilter;
import com.guanting.manager.shiro.MyRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(DefaultWebSecurityManager securityManager) {
        ...
        filterMap.put("/apiUser/login", "anon");

       // 冠霆业务接口不拦截
        filterMap.put("/test/*", "anon");
        filterMap.put("/finaConsume/*", "anon");
