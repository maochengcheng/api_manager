...
$(function() {
    layui.use('table', function(){
        ...
        tableIns=table.render({
            ...
            cols: [[
                {type:'numbers'}
                ,{field:'tableType', title:'表类型',align:'center'}
                ,{field:'tableName', title:'表名',align:'center'}
                ,{field:'tableComment', title:'表说明',align:'center'}
                ,{field:'createTime', title: '注册时间',align:'center'}
                ,{field:'flag', title: '是否有效',align:'center'}
        ...
        table.on('tool(tableTable)', function(obj){
            var data = obj.data;
            if(obj.event === 'editTableExplain'){

                console.log('修改'+data);
                //删除
                openTableExplain(data,"编辑");
            } else if(obj.event === 'lookTable'){
                //编辑
                openTableExplain(data,"编辑");
            }else if(obj.event === 'lookTableData'){
                //恢复
                openTableExplain(data,"编辑");
            }
        });
        ...
        //监听提交
        form.on('submit(tableExplainSubmit)', function(data){
            // TODO 校验
            formSubmit(data);
            return false;
        });
...
function formSubmit(obj){
    $.ajax({
        type: "POST",
        data: $("#tableExplainForm").serialize(),
        url: "/table/setTableExplain",
...
function openTableExplain(data,title){
    console.log(data);
